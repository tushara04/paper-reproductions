...
### Requirements
To start, first set up a virtual environment in a project directory. Note that the commands that follow are run on Arch Linux but they can similarly be ran on other OS.
